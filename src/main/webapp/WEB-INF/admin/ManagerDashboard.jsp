                        ...
                        <%@page import="service.AdminDAO" %>
                            <%@page import="beans.Item" %>
                                <%@page import="jakarta.servlet.http.HttpSession" %>
                                    ...
                                    <body>
                                        <% HttpSession checksession=request.getSession(false); String check=(String)
                                            checksession.getAttribute("AdminEmail"); if (check==null ||
                                            check.equals("")){ %>
                                            <h1>Page not found</h1>
                                            <% } else { %>
                                                <jsp:include page="Managerheader.jsp" />
                                                <% AdminDAO currDAO=new AdminDAO(); List<Admin>all = currDAO.getAll();
                                                    Integer itemAdmin = 0;
                                                    Integer UserAdmin = 0;
                                                    Integer manager = 0;
                                                    Integer Total = 0;
